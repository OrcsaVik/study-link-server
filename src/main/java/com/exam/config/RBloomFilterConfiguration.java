...
public class RBloomFilterConfiguration {
    ...
    // String prefix = RedisBloomCacheConstant.CACHE_FIX;
    // RBloomFilter<String> bloomFilter = redissonClient.getBloomFilter(prefix + "couponTemplateQueryBloomFilter");
     ...
     */
    @Bean
    public RBloomFilter<String> videoLikeBloomFilter(RedissonClient redissonClient) {
        String prefix = RedisBloomCacheConstant.CACHE_FIX;
        RBloomFilter<String> bloomFilter = redissonClient.getBloomFilter(prefix + "videoLikeBloomFilter");
        bloomFilter.tryInit(640L, 0.01);
        return bloomFilter;
    }
}
