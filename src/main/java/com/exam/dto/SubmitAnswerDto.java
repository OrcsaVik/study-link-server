...
public class SubmitAnswerDto implements Serializable {
    ...
    @Schema(description = "题目ID，指定回答的是哪道题", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "题目ID不能为空")
    private Integer questionId; // 题目ID

    @Schema(description = "用户提交的答案", example = "A", requiredMode = Schema.RequiredMode.REQUIRED)
